(function( $ ) {
	...
	var EditableTable = {
		...
		rowAdd: function() {
			...
			actions = [
				'<a href="#" class="row-save hidden state-edit"><i class="fa fa-save"></i></a>',
				'<a href="#" class="row-cancel hidden state-edit"><i class="fa fa-times"></i></a>',
				'<a href="#" class="row-edit state-default"><i class="fa fa-pencil"></i></a>',
				'<a href="#" class="row-remove state-default"><i class="fa fa-trash-o"></i></a>'
			].join(' ');
